...
export function success(data: unknown) { return noStore(NextResponse.json({ ok: true, data })); }
export function failure(error: unknown) { return noStore(errorResponse(error)); }
